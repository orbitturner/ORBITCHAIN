angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app.html',
    ...
    "            <a href=\"#!/\" class=\"navbar-brand\">ORBITCHAIN</a>\n" +
    "        </div>\n" +
    "\n" +
    ...
    "    </div>\n" +
    "</nav>\n" +
    "<a ng-if=\"$root.isActive('/')\" href=\"https://github.com/orbitturner/ORBITCHAIN/\">\n" +
  ...
  $templateCache.put('pages/intro/intro.html',
    ...
    "\n" +
    "<p class=\"pull-right\">\n" +
    "  by <a href=\"https://github.com/orbitturner\">Orbit Turner</a><br>\n" +
